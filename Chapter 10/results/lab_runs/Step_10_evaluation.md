...
_The evaluation triad: FaithfulnessEvaluator checks the answer is grounded in the retrieved context, AnswerRelevancyEvaluator scores the answer against the question, and ContextRelevancyEvaluator scores the retrieved context against the question._

## Q: What was Acme's net income per diluted share in fiscal 2024?

### Retrieved context (1 chunk(s))

**Chunk 1** — source `acme_10k_excerpt.md`, score 0.597
...
Acme Robotics reported net income of **$1.92 per diluted share** in fiscal 2024, with total net income of $48.9 million.

> Faithful to sources? True | Answer relevancy (0-1): 1.0 | Context relevancy (0-1): 1.0
