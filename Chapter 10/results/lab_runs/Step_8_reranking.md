...
_Retrieve a broad top-6 from the 10-K, then an LLMRerank postprocessor re-scores and keeps the best 2 chunks._

## Q: What was Acme's gross margin in fiscal 2024 and why did it expand?

### Retrieved context (1 chunk(s))

**Chunk 1** — source `acme_10k_excerpt.md`, score 10.000
...
## Acme Robotics Gross Margin — Fiscal 2024

Acme's gross margin in fiscal 2024 was **43.1%**, expanding from **40.2%** in fiscal 2023, representing an improvement of approximately **2.9 percentage points**.

### Reason for Expansion

The gross margin expansion was driven by a **higher software mix** in the overall revenue. Specifically, the **Software & Services segment** (the AcmeFleet subscription platform) grew significantly — up **34% year over year** — reaching **$188.7 million**, or **31% of total revenue**. Since software typically carries higher margins than hardware, this shift in revenue composition toward a greater proportion of software and services revenue was the primary driver of the improved gross margin.
